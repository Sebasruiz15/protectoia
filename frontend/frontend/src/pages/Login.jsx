...
// Ícono de marca — arcos de señal (mismo lenguaje visual, sin texto de GESCO)
const IconLogoMark = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    <circle cx="6" cy="18" r="2.2" fill="#f4e409" />
    <path
      d="M9 15.5c1.8-1.8 4.7-1.8 6.5 0"
      stroke="#f4e409"
      strokeWidth="1.8"
      strokeLinecap="round"
      opacity="0.85"
    />
    <path
      d="M6.5 12c3.5-3.5 9-3.5 12.5 0"
      stroke="#f4e409"
      strokeWidth="1.8"
      strokeLinecap="round"
      opacity="0.55"
...
function RedNodos({ canvasRef }) {
  useEffect(() => {
    ...
    const nodos = Array.from({ length: TOTAL }, (_, i) => ({
      ...
      // Hub principal más grande y blanco — el resto de nodos queda neutro
      // (el amarillo señal se reserva para el paquete de datos, no para el fondo)
      color:
        i === 0
          ? "#ffffff"
          : Math.random() > 0.65
    ...
    const loop = () => {
      ...
      for (let k = paquetes.length - 1; k >= 0; k--) {
        ...
        ctx.fillStyle = "#f4e409"; // amarillo señal — la única nota de color en la red
        ctx.fill();
...
export function Login() {
  ...
  const onSubmit = async ({ email, password }) => {
    ...
    try {
      ...
      if (err.status === 403) {
        navigate("/registro", {
          state: { empresa_id: err.data?.empresa_id, email },
        });
        return;
      }
      ...
      >
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            />
            <span
              className="text-[10px] tracking-widest font-medium font-mono"
              style={{ color: "#f4e409" }}
            >
          ...
          <div>
            <h2 className="font-display text-[28px] font-semibold text-white leading-snug">
              ...
              <br />
              <span style={{ color: "#f4e409" }}>automatizado con IA</span>
            </h2>
            <p
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  aria-label={
                    verPassword ? "Ocultar contraseña" : "Ver contraseña"
                  }
              ...
              <div className="flex justify-end -mt-1">
                <Link
                  ...
                  style={{ color: "#f4e409" }}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "#fdf59e")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = "#f4e409")
                  }
                >
  ...
  return (
    <div
      ...
      style={{
        ...
        height: "80px",
        background:
          "linear-gradient(to bottom, transparent, #f4e409, transparent)",
